...
Isadmin=$(curl -sS https://raw.githubusercontent.com/tridebleng/permission/main/ipmini | grep $MYIP | awk '{print $5}')
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/tridebleng/update/main/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/tridebleng/permission/main/version)
...
serverV=$( curl -sS https://raw.githubusercontent.com/tridebleng/permission/main/version)
if [ "$Isadmin" = "ON" ]; then
